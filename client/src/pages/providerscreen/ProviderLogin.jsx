    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-4">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <img
          ...
          alt="Your Company"
        />
        <h2 className="flex mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-800 sm:whitespace-nowrap justify-center">
          Please create a 1Step Health account to continue
        </h2>
        <h2 className="flex mt-4 text-center text-sm font-bold leading-9 tracking-tight text-gray-600 sm:whitespace-nowrap justify-center">
          You&apos;ll use this account to access your profile
        </h2>
      </div>
