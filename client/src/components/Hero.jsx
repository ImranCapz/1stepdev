...
const Hero = () => {
  ...
  return (
    <section>
      ...
      <div className="flex flex-rows mx-auto md:p-10 chatbgimage max-w-screen-4xl">
        <HowItWorks />
      </div>
      ...
      <div className="flex flex-col px-4 py-9 mx-auto justify-center items-center">
        ...
        <div className="mx-auto lg:px-32 2xl:w-[1400px] grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 text-center gap-6 md:gap-8 mt-8">
